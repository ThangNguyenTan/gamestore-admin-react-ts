...
const updateDeveloperReducer = (
    state: IState = initialState,
    action: DeveloperAction
): IState => {
    switch (action.type) {
        case DeveloperActionType.UPDATE_DEVELOPER_REQUEST:
            return {
                ...state,
                loading: true,
                error: null,
        ...
        case DeveloperActionType.UPDATE_DEVELOPER_FAIL:
            return {
                ...state,
                loading: false,
...
export default updateDeveloperReducer
