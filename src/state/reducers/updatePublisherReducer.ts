...
const updatePublisherReducer = (
    state: IState = initialState,
    action: PublisherAction
): IState => {
    switch (action.type) {
        case PublisherActionType.UPDATE_PUBLISHER_REQUEST:
            return {
                ...state,
                loading: true,
                error: null,
        ...
        case PublisherActionType.UPDATE_PUBLISHER_FAIL:
            return {
                ...state,
                loading: false,
...
export default updatePublisherReducer
